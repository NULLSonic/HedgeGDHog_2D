...
func destroy():
	...
	match (item):
		...
		3: # Shield
			...
			Global.activeShields.append(playerTouch.SHIELDS.NORMAL)
		4: # Elec
			playerTouch.set_shield(playerTouch.SHIELDS.ELEC)
			Global.activeShields.append(playerTouch.SHIELDS.ELEC)
		5: # Fire
			playerTouch.set_shield(playerTouch.SHIELDS.FIRE)
			Global.activeShields.append(playerTouch.SHIELDS.FIRE)
		6: # Bubble
			playerTouch.set_shield(playerTouch.SHIELDS.BUBBLE)
			Global.activeShields.append(playerTouch.SHIELDS.BUBBLE)
		7: # Super
